 ...
 * @{
 * @defgroup	CARME_SDIO_SD_LLD CARME SDIO SD LLD
 * @brief		Low level driver for CARME SDIO SD
 * @{
 *
 ...
 *			Disable SDIO Clock, Set Power State to OFF, DeInitializes the
 *			SDIO peripheral, Disable the SDIO APB2 Clock
 */
